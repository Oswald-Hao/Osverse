...
![Osverse 环境总览](docs/assets/screenshots/overview.png)
...
![Osverse 检测 Claude Code 与 Codex CLI](docs/assets/screenshots/cli-detection.png)
...
![Osverse API 档案编辑器](docs/assets/screenshots/api-profiles.png)

</details>

以上截图均来自 Ubuntu 22.04 上真实运行的 1280×800 Osverse，不是概念稿。

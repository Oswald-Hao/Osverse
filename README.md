...
![Osverse environment overview](docs/assets/screenshots/overview.png)
...
![Osverse detects existing Claude Code and Codex CLI installations](docs/assets/screenshots/cli-detection.png)
...
![Osverse encrypted API profile editor](docs/assets/screenshots/api-profiles.png)

</details>

All screenshots above are from a real 1280×800 Osverse session on Ubuntu 22.04, not design mockups.

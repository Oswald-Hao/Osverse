...
<p align="center">
  ...
  Detect, install, update, launch, and safely remove Claude Code, Codex CLI, OpenCode, DeepSeek Harness, Qwen Code, desktop apps, and third-party API profiles from one place.
</p>
...
- **Find what is already there.** Claude Code, Codex CLI, OpenCode, and Qwen Code are discovered from the user's effective command paths; they do not need to live inside an Osverse directory.
...
| --- | --- | --- |
| Core CLI | Claude Code, Codex CLI, OpenCode CLI, DeepSeek Harness, and Qwen Code detection plus transactional install/update | Same; Harness and Qwen Code use verified private runtimes |
...
Osverse is an independent project. Claude, Codex, OpenAI, OpenCode, DeepSeek, Qwen, and other product names belong to their respective owners; inclusion indicates interoperability, not endorsement.

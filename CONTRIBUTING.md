...
Wails bindings under `frontend/wailsjs` are generated from the Go API. Regenerate them with Wails 2.15.0 when the public backend contract changes, and include only intentional output. Keep the 1280×800 default layout usable at every breakpoint covered by the responsive audit.
